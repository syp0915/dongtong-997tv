...
/**
 * @Package com.shfc.nnstv.exception.RestExceptionHandler
...
public class RestExceptionHandler {
    ...
    //cloud web 异常
    @ExceptionHandler({NNSWebException.class})
    @ResponseBody
    public ResultDO<String> cloudWebException(NNSWebException NNSWebException) {
        logException(NNSWebException);
        resultDO.setErrCode(NNSWebException.getErrCode());
        resultDO.setErrMsg(NNSWebException.getMessage());
        return resultDO;
    }
    ...
    private void logException(Exception e){
        e.printStackTrace();
        Logger.error(RestExceptionHandler.class, e.getMessage(), e);
    }
}
