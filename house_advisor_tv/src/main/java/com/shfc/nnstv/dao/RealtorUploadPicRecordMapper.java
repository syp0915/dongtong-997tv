...
import com.shfc.nnstv.domain.RealtorUploadPicRecord;
import org.springframework.stereotype.Repository;

/**
 * @Package: com.shfc.nnstv.dao.RealtorUploadPicRecordMapper.java
 * @Description: 
 * @Company: 上海房产
...
public interface RealtorUploadPicRecordMapper {
     ...
     * @Date 2017/04/20 14:04
     * @param id
     * @return com.shfc.nnstv.domain.RealtorUploadPicRecord
     * @throws []
     */
