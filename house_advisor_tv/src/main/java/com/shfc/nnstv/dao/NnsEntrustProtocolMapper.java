...
import com.shfc.nnstv.domain.NnsEntrustProtocol;
import org.springframework.stereotype.Repository;

/**
 * @Package: com.shfc.nnstv.dao.NnsEntrustProtocolMapper.java
 * @Description: 委托协议表
 * @Company: 上海房产
...
public interface NnsEntrustProtocolMapper {
     ...
     * @Date 2017/04/20 14:04
     * @param id
     * @return com.shfc.nnstv.domain.NnsEntrustProtocol
     * @throws []
     */
