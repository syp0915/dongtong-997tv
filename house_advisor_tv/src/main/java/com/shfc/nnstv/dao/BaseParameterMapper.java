...
import com.shfc.nnstv.domain.BaseParameter;
import org.springframework.stereotype.Repository;

/**
 * @Package: com.shfc.nnstv.dao.BaseParameterMapper.java
 * @Description: 参数管理表
 * @Company: 上海房产
...
public interface BaseParameterMapper {
     ...
     * @Date 2017/04/20 14:04
     * @param id
     * @return com.shfc.nnstv.domain.BaseParameter
     * @throws []
     */
    BaseParameter selectByPrimaryKey(Long id);
