package com.shfc.nnstv.constant;
...
public enum  ErrorConstant {
    ...
    REMOTE_SERVER_RESULT_EXCEPTION(4001, "远程服务器返回结果异常"),
    JSON_STRING_CAST_EXCEPTION(4002, "json字符串转换异常"),
    INVALID_TVBOX_MAC(4003, "无效的机顶盒信息"),
    TVBOX_INFO_PARAM_EXCEPTION(4004, "机顶盒信息参数异常"),
    IMPORT_EXCEPTION(4005, "数据导入异常"),
    INVALID_FILE_PATH(4006, "无效的文件路径");
