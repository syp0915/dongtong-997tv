...
/**
 * @Package: com.shfc.nnstv.domain.RealtorStore.java
 * @Description: 经纪公司门店
 * @Company: 上海房产
...
public class RealtorStore extends BaseBean {
    ...
    public String toString() {
        ...
        sb.append(", realtorCompanyId=").append(realtorCompanyId);
        ...
        sb.append(", storex=").append(storex);
        sb.append(", storey=").append(storey);
        sb.append(", storeLonLat=").append(storeLonLat);
        sb.append(", fillingCerNo=").append(fillingCerNo);
        sb.append(", storeStatus=").append(storeStatus);
        sb.append(", storeImg=").append(storeImg);
        sb.append(", shopowner=").append(shopowner);
        sb.append(", shopownerTel=").append(shopownerTel);
        sb.append(", shopownerPic=").append(shopownerPic);
        sb.append("]");
        return sb.toString();
    }
}