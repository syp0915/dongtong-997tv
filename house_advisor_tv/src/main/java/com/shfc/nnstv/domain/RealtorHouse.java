...
/**
 * @Package: com.shfc.nnstv.domain.RealtorHouse.java
...
public class RealtorHouse extends BaseBean {
     ...
     * 获取系统小区名称
     *
     * @return sys_plot_name
     */
    public String getSysPlotName() {
        return sysPlotName;
    }
     ...
     * @param sysPlotName
     */
    public void setSysPlotName(String sysPlotName) {
        this.sysPlotName = sysPlotName == null ? null : sysPlotName.trim();
    }
