...
/**
 * @Package: com.shfc.nnstv.domain.RealtorCompany.java
 * @Description: 经纪公司
 * @Company: 上海房产
...
public class RealtorCompany extends BaseBean {
     ...
     * 签章负责人类型 1-代理人 2-法人
     */
    private Integer chargePersonType;
     ...
     */
    public Integer getChargePersonType() {
     ...
     */
    public void setChargePersonType(Integer chargePersonType) {
    ...
    public String toString() {
        ...
        sb.append(", comAbbr=").append(comAbbr);
        sb.append(", comCreateAt=").append(comCreateAt);
        sb.append(", comStatus=").append(comStatus);
        sb.append(", comType=").append(comType);
        sb.append(", comTel=").append(comTel);
        sb.append(", comImg=").append(comImg);
        sb.append(", linkman=").append(linkman);
        sb.append(", contractNumber=").append(contractNumber);
        sb.append(", storeNum=").append(storeNum);
        sb.append(", realtorNum=").append(realtorNum);
        sb.append(", tradingCenterNo=").append(tradingCenterNo);
        sb.append(", codeNo=").append(codeNo);
        sb.append(", codeType=").append(codeType);
        sb.append(", chargePerson=").append(chargePerson);
        sb.append(", chargePersonType=").append(chargePersonType);
        sb.append(", chargePersonIdentity=").append(chargePersonIdentity);
        sb.append(", qText=").append(qText);
        sb.append(", sealData=").append(sealData);
        sb.append("]");
        return sb.toString();
    }
}