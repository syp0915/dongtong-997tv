...
/**
 * @Package com.shfc.nnstv.interceptors.NNSResponseInterceptor
 ...
 */
@ControllerAdvice
public class NNSResponseInterceptor implements ResponseBodyAdvice {
    @Override
...
//                return result;
//            } catch (Exception e) {
//                Logger.error(NNSResponseInterceptor.class, "响应结果加签失败", e);
//            }
//        }
